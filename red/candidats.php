                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div class="container" id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dvcb' AND house = 'red'";
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dvcg' AND house = 'red'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'vcb' AND house = 'red'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'vcg' AND house = 'red'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dcb' AND house = 'red'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dcg' AND house = 'red'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'cb' AND house = 'red'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'cg' AND house = 'red'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
