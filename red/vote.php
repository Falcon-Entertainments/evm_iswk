...
if ($ress->num_rows != 0) {
	$_SESSION['message'] = 'Voter with this GR.NO has already casted his/her voted!';
	header("location: error.php");
}
// submit
		...
		<div class="wrap-login100 p-t-190 p-b-30">
			<div class="container-contact100">
				...
				<button class="contact100-btn-show">
					<p class="txt-rotate fa" data-period="2000" data-rotate='["lets go"]' aria-hidden="true">lets go</p>
				</button>
