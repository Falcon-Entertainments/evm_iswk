...
<head>
    ...
    <title>Admin Dashboard - Blue Vice Captain Girl</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="data-tables">
                            <table id="dataTable" class="text-center">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($mysqli->query('SELECT vcg,COUNT(vcg) FROM votesb GROUP BY vcg') as $row) {
                                        echo "<tr>";
                                        $post = "Vice Captain Girl";

                                        /* To check which name in the encription */
                                        foreach ($mysqli->query("SELECT enc,name FROM candidates WHERE house = 'blue' AND post = 'vcg'") as $row1) {
                                            if ($row['vcg'] == $row1['enc']) {
                                                $vcgname = $row1['name'];
                                                break;
                                            }
