                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dvcb' AND house = 'green'";
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dvcg' AND house = 'green'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'vcb' AND house = 'green'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'vcg' AND house = 'green'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dcb' AND house = 'green'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'dcg' AND house = 'green'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'cb' AND house = 'green'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
                        ...
                        <div class="wrap-input100">
	                        ...
	                        <div id="radios">
                                <?php
                                    $sql="SELECT * FROM candidates WHERE post = 'cg' AND house = 'green'";
                                    $result = mysqli_query($mysqli,$sql);
                                    while($row = mysqli_fetch_array($result)) {
                                        echo '<label for="' . $row['enc'] .'" class="material-icons">';
