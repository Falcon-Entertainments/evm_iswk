...
<head>
	...
	<meta name="theme-color" content="#00ea14" />
	<!-- Chrome, Firefox OS and Opera -->
	<meta name="theme-color" content="#00ea14">
	<!-- Windows Phone -->
	<meta name="msapplication-navbutton-color" content="#00ea14">
	<!-- iOS Safari -->
	<meta name="apple-mobile-web-app-status-bar-style" content="#00ea14">
