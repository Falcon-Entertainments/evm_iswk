...
Mousetrap.bind('y e', function(e) {
    window.open('yellow');
});
Mousetrap.bind('b l', function(e) {
    window.open('blue');
});
Mousetrap.bind('h c', function(e) {
    window.open('headcouncil');
});
Mousetrap.bind('?', function(e){
    alert("<br>a d Admin <br> g r green ");
});